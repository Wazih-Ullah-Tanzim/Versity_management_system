					...
					<div class="row">
						<div class="col-lg-5 col-md-6 col-sm-6">
							<div class="single-footer-widget">
								<h6>About Us</h6>
								<h6>Department of Economics Library</h6>
                                <p>
                                    Saturday - Wednesday: 8.30 am - 4.30 pm
                                </p>
                                <h6>Faculty of Engineering Library</h6>
                                <p>Saturday - Wednesday: 8.30 am - 4.30 pm</p>
                                <h6>Department of Law Library</h6>
                                <p>Saturday - Wednesday: 8.30 am - 4.30 pm
			...
			<script src="{{url('frontend/https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous')}}"></script>
